...
int QtDeployInstaller( char* a_wlacRoot, int isSystem);
int QtDeployUninstaller( char* a_wlacRoot, int isSystem);
int QtDeployUpdater(char* a_installerDir, int isSystem);


static const SOptionFuncPair s_vAllOptions[] = {
	{"/Install",&QtDeployInstaller},
	{"/Uninstall",QtDeployUninstaller},
	{ "/Rollback",QtDeployUpdater },
	{ "/Update",QtDeployUpdater },
};
